...
- Apparently if Eq_uneq doesn't reduce directly to either endpoint of the path for concrete canonical values of I, then we can't derive funext directly. Not sure if this fun fact is worth mentioning.
