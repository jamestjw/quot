...
At some point, I'd like to mention that Eq types are not defined as `native' datatypes because our inductive types are not indexed datatypes. To encode indexed datatypes using our inductive types, we would require use of Eq types itself, i.e. we have a chicken and egg problem here. (Detailed explanation of this likely doesn't belong in the intro, could bring it up in passing in the intro.)
