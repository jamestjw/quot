...
TODO\: Mention how a quotient type is a coequaliser of two `parallel' functions (i.e.\  the two projections of a pair that are related by an equiv relation) and compare this to actual code.
