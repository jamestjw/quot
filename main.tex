...
Negation       & 0.2825   & 0.3872  & 0.0272 & 0.0201  & 0.1047  \\
Addition       & 0.5268   & 0.8354  & 0.0308 & 0.0415  & 0.3086  \\
Subtraction    & 0.6899   & 1.1180  & 0.0411 & 0.0286  & 0.4281  \\
Multiplication & 0.4877   & 0.8000  & 0.0346 & 0.0372  & 0.3123 \\ \bottomrule
\end{tabular}
...
our propositions are fairly standard, we thus leave them for future work.
...
using \id{Quotient\_rec2}, we observe how the two operations have a similar
overhead. Since we defined \id{Rational\_-} based on \id{Rational\_+} combined
with \id{Rational\_negate}, it is well justified that its overhead is similar to
the combined overhead of the two operations that it was defined on.
