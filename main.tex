...
sigma-type, we need a provide a term of type \id{A} and a witness that the
...
represented by the following inductive type by using the `propositions as
types' variation of logical negation, \id{Not}, as introduced in
