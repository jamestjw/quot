...
%% TODO: Check if I have an appropriate definition of "propositional equality"
%% as I've definitely used the term
...
defintionally equal to $M$, we are saying that the former reduces to the latter
...
be equal to $\id{P}$ itself. Equalities between equality proofs are only an
important consideration in a proof-relevant world, e.g.\ in the context of HoTT.
In the world of Typer where we demand that equality proofs be erasable and play
no role
