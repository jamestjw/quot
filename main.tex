...
%% TODO: Add proof of $\kw{cong}_2$ in the appendix or something (sketch is in
%% Interval.lagda.md)
...
%% TODO: If we return \id{a} for arbitrary values of \id{r}, we break subject
%% reduction I believe? Check and mention this
...
actually sufficient to derive functional extensionality.
