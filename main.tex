...
lemmas that we ultimately use to prove the commutativity of addition.
...
$\fn{Rational\_*}$ on 15000 pairs of rational numbers with 500 iterations. We
then report the average execution time over the 500 iterations along with the
