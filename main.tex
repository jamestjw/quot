...
%% SM: Weird alignment.
%% SM: You have not yet defined `Sigma` and `sigma`.
%% Maybe use the Σ/<a,b> notation you used earlier?
\begin{minted}[escapeinside=@@,mathescape=true]{haskell}
...
%% SM: This ends up referring to the section in which we already are!
...
%% SM: AFAICT this is needed to prove J, but it is not needed for the reader
%% to understand the rest of your work, so maybe it's best to move it to
%% the appendix.
...
%% SM: You need to show more details to explain why these correspond
%% to the sides of your square.
