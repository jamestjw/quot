...
We present the existing version of Typer's equality type before presenting our
implementatio of cubical equality in Typer. This is done notably to familiarise
readers with Typer's equality in general and to highlight the advantages of
cubical equality in subsequent chapters. This knowledge is nevertheless not
...
have a type former \fn{\_$\equiv$\_ $\colon$ A $\rightarrow$ A $\rightarrow$ Type}
...
\begin{minted}[escapeinside=@@,mathescape=true]{agda}
rec2 : (A B C: Type) @$\Rrightarrow$@
       (R : A @$\rightarrow$@ A @$\rightarrow$@ Type) @$\Rrightarrow$@
       (S : B @$\rightarrow$@ B @$\rightarrow$@ Type) @$\Rrightarrow$@
