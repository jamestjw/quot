...
The traditional appropach of adding functional extensionality to an ITT as an
...
equality proof between them. The implementation of cast in proof assistants
...
motive \id{f} does not use its argument. Our implementation of cast recognises
...
\begin{minted}[escapeinside=@@,mathescape=true]{agda}
    ...
    np2 = Eq_cast (p := eqf) (f := NatPred) np1
\end{minted}
