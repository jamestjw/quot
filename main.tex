...
translation of the latter version to the former may be done by repackaging the path
constructors introduced by the QIT as constructors of a new relation over which we shall
construct a new quotient type.
...
\section{Initial object of quotient set algebras}

TODO:\ Ok maybe let's scratch this, this isn't super interesting.
