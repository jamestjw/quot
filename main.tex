...
%% SM-FIXME: This `I` looks like a weird box/rectangle.
%% Maybe try and find a similar thing but with serifs?
...
%% SM-FIXME: You have not defined `eqtype` yet.
\begin{prooftree*}
...
%% SM-FIXME: The readers may be confused by the term "recursion" since outside
%% of this domain, the term is usually restricted to more complex cases,
%% so you should point this out clearly.
...
\begin{prooftree*}
   ...
   %% SM-FIXME: You don't have to include A, M, and N in the syntax of `rec`.
...
\begin{align*}
  ...
  %% SM-FIXME: You have not defined `cong` yet.
  & \kw{cong}_{rec_{\bI}(\_ . A, M, N, P)}(\id{seg}) = P
\end{align*}

%% SM-FIXME: While equalities between equality proofs are an interesting topic,
%% it's one that your system doesn't really tackle (because Typer wants
%% something similar to K), and with which most readers won't be familiar,
%% so clarify that this is all in the HoTT world.
...
%% SM-FIXME: Lots of concepts you haven't presented here.
...
\subsubsection{Axiom}
%% SM-NOTE: I like that you explain that we need to convince ourselves that
%% the new equality constructor doesn't break our system...
%% SM-FIXME: ...but maybe you'll want to spell it out more fully and visibly
%% because for some readers it may be a subtle point that they might miss.
%% E.g. with a more specific sub*section title.
...
%% SM-FIXME: Beware of unproven assertions such as "This gives us good
%% runtime efficiency".  This can only be true if you define clearly what
%% you mean by "naive implementations".
...
%% SM-FIXME: Not sure we want to go there for your MSc.
...
We define the above type, intending to return the propositional truncatin of it as a proof of the surjectivity of $\kw{Quotient\_in}$. The proof goes as follows:
...
TODO\: Add Agda example of Quotient defined as a HIT here
